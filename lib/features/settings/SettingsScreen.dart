              ...
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFFCDDEE3),
                      // 버튼 배경색
                      foregroundColor: const Color(0xFF504A4A),
                      // 버튼 글자, 아이콘 색상
                ...
                Expanded(
                  ...
                  child: ElevatedButton(
                    /// ------------------------------
                    /// 함수명: onPressed
                    /// 목적: 친구 관리 버튼 클릭 시 friend_management 화면으로 이동
                    /// 입력: 없음
                    /// 반환: 없음
                    /// 예외: 없음
                    /// ------------------------------
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const friend_management(),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Container(width: 1.5, height: 48, color: const Color(0xFFE5E5E5)),
                                        Expanded(
                                          child: InkWell(
